...
const Home = () => {
  ...
  return(
    ...
    <Header/>
    <Row className="commom-main" justify="center" type="flex">
      <Col  className="commom-left" xs={24} sm={24} md={10} lg={15} xl={14}>
          <List
            header="最新推荐"
            itemLayout="vertical"
            dataSource={list}
      ...
      <Col className="commom-right" xs={0} sm={0} md={14} lg={8} xl={4}>
        <Author/>
        <Advert/>
      </Col>
    </Row>
